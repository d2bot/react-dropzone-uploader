...
var Dropzone = /** @class */ (function (_super) {
    ...
    function Dropzone(props) {
        ...
        _this.handleChangeStatus = function (fileWithMeta) {
            ...
            if (meta) {
                delete meta.status;
                fileWithMeta.meta = __assign({}, fileWithMeta.meta, meta);
                _this.forceUpdate();
            }
        };
    ...
    Dropzone.prototype.render = function () {
        ...
        if (dropzoneDisabled) {
            ...
            style = __assign({}, (style || {}), (dropzoneDisabledStyle || {}));
        }
        else if (reject) {
            className = className + " " + dropzoneRejectClassName;
            style = __assign({}, (style || {}), (dropzoneRejectStyle || {}));
        }
        else if (active) {
            className = className + " " + dropzoneActiveClassName;
            style = __assign({}, (style || {}), (dropzoneActiveStyle || {}));
        }
        return (
        //@ts-ignore
